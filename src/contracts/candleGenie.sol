...
contract CandleGeniePrediction is Ownable, Pausable, ReentrancyGuard 
{
    ...
    uint256 public roundDuration = 4 minutes;
    // uint256 public minBetAmount = 0.01 ether;
    uint256 public minBetAmount = 5000000000000000;
    ...
    function _calculateRewards(uint256 epoch) public 
    {
    ...
    function RoundLock(int256 price) external whenNotPaused 
    {
    ...
    function RoundExecute(int256 price) external whenNotPaused 
    {                                                                                               
